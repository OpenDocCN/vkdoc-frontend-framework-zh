...
重新设计一个用户界面需要最少的努力。例如，我可以快速获得一个默认主题的 jQuery Mobile 应用(参见[Figure 1–13](#fig_1_13))，然后在几秒钟内用另一个内置主题重新设计它。在我修改主题的情况下(见[图 1–14](#fig_1_14)，我从列表中选择了一个替换主题。唯一需要的标记是添加一个数据主题属性。我们将在《T4》第 7 章中更详细地讨论主题。
